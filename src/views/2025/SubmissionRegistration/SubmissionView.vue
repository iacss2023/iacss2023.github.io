      ...
      <div class="view-main">
        ...
        <div class="view-section">
          ...
          <ul>
            ...
            <li><p>The deadline for submission of abstractions is April <s>15</s> 30, 2025 at 23:59 AoE (UTC-12).</p></li>
          </ul>
        </div>
        <div class="view-section">
...
<!--            <li><p>The abstract must be uploaded to the EasyChair platform through authors account.</p></li>-->
          ...
          <p>Authors whose papers meet the publication requirements of the association’s journal, <i>International Journal of Computer Science in Sport</i> (IJCSS), will be invited to submit a full paper. The submission will undergo the regular submission process, peer review, and open-access publication by IJCSS.
            ...
            Authors of other papers may also be invited to submit full papers (8-15 pages), which will be published by <strong>Springer</strong> as part of the conference proceedings series <i>Lecture Notes on Data Engineering and Communications Technologies</i> (EI).</p>
