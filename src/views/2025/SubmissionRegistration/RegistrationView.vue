...
export default {
  ...
  data () {
    return {
      feeInfo: [
        { affair: 'Full – Non-member', earlyBird: '40,000', standard: '45,000' },
        { affair: 'Full - Member', earlyBird: '35,000', standard: '40,000' },
        { affair: 'Student - Non-member', earlyBird: '30,000', standard: '40,000' },
        { affair: 'Student - Member', earlyBird: '15,000', standard: '20,000' },
        { affair: 'Exhibitors', earlyBird: '10,000', standard: '15,000' },
        { affair: 'Accompanying Person', earlyBird: '15,000', standard: '20,000' }
      ]
    }
  },
  methods: {}
