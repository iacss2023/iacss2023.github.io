<template>
  <div>
    <div class="view-container">
      <div class="view-title">组委会</div>
      <div class="view-main">
        <div class="view-text">
          <el-tabs v-model="activeTab" class="demo-tabs">
            <el-tab-pane label="科学组委会" name="scientific">
              <div class="view-section-title">科学组委会（建议名单）</div>
            ...
            <el-tab-pane label="大会组委会" name="organizing">
              <div class="view-section-title">大会组委会（建议名单）</div>
